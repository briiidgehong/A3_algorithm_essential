...
```
구현/시뮬레이션:
2979PPP, 1157P, 10431P, 8979M, 7568P
소수판별: 1978PPP + 1929PM, 2581P, 4948P, 11653P, 2023M
최대공약수, 최소공배수: 2609PPP, 9613P, 2485T, 1735P, 3036P
진수변환: 2998PM, 3460PP
...
완전탐색:
2231PP, 1436MP, 1018M, 17484M(BFS/DFS(백트래킹))

그리디:
11047PP, 1343PP, 14916P, 2828P

DP:
2193PP, 1463P, 11726P, 2579M, 12865TT
LIS, LCS: 11053M, 9251M, 9252M
이코테 개미전사, 1로 만들기, 효율적인 화폐구성, 금광

이진탐색:
30792P, 1920P, 2805P, 10816P

투포인터:
2559PP, 3273P, 2470P, 1806T, 1644T

BFS, DFS:
1926PM, 2667P, 2178P, 1260P, 2644P, 1012P, 7562P, 11724, 11403

백트래킹:
9663PPP, 프로그래머스 여행경로M

다익스트라, 플로이드 와샬 (최단경로 알고리즘):
1238PMM, 4485MM, 11404M, 이코테 전보P, 이코테 미래도시M

union find:
1717MMP, 1976MP, 10775T

크루스칼 / 프림 (MST)
1197MMP, 1922M, 1647M, 4386M
