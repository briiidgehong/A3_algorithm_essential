...
```
구현/시뮬레이션:
2979PP, 1157P, 10431P, 8979PT, 7568P
소수판별: 1978PP, 1929P, 2581P, 4948P, 11653P, 2023PT
...
완전탐색:
2231PP, 1436PT, 1018PT, 17484PT(BFS/DFS(백트래킹))

그리디:
11047PP, 1343P, 14916P, 2828P

DP:
2193PP, 1463P, 11726P, 2579PT, 12865TT
...
BFS, DFS:
1926PPT, 2667P, 2178P, 1260P, 2644P, 1012P, 7562P, 11724, 11403

백트래킹:
9663PP, 프로그래머스 여행경로PT

다익스트라, 플로이드 와샬 (최단경로 알고리즘):
1238PTP, 4485PTPT, 11404PT, 이코테 전보P, 이코테 미래도시PT

union find:
1717PTPT, 1976PTP, 10775T

크루스칼 / 프림 (MST)
1197PTPT, 1922PT, 1647PT, 4386PT
